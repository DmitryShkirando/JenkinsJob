...
- Name: playTest.spec.ts >> Header Navigation Bar Suite >> Checking showing top bar
- Location: tests\playTest.spec.ts:12:7
...
Locator: getByRole('link', { name: 'Playwright logo Playwright11' })
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toBeVisible" getByRole('link', { name: 'Playwright logo Playwright11' }) with timeout 5000ms
  - waiting for getByRole('link', { name: 'Playwright logo Playwright11' })
...
> 15 |       await expect(page.getByRole('link', { name: 'Playwright logo Playwright11' })).toBeVisible();
     |                                                                                      ^ Error: expect(locator).toBeVisible() failed
  16 |     });
  17 | 
  ...
  39 |       await expect(page.getByRole('link', { name: 'Playwright logo Playwright' })).toContainText(
  40 |         'Playwright',
  41 |       );
